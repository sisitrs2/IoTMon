...
VALUES("Baba", "1.1.1.1", 1, "1.0", "26", "54.23", "34.52", "Alarm", "Power Outage", "08/08/2022 12:56:12", "http://1.1.1.1/", 1, 1);
INSERT INTO devices(name, address, type_id, version, temperature, voltage, current, status, data, lastscan, link, device_user_id, area_id) 
...
INSERT INTO devices(name, address, type_id, version, temperature, voltage, current, status, data, lastscan, link, device_user_id, area_id) 
VALUES("Baba", "1.1.2.1", 2, "1.0", "-", "-", "-", "Unaccessible", "Couldn't connect.", "08/08/2022 12:56:12", "http://1.1.2.1/", 2, 1);
INSERT INTO devices(name, address, type_id, version, temperature, voltage, current, status, data, lastscan, link, device_user_id, area_id) 
